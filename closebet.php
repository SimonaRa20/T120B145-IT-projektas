...
<body>
    <div>
        ...
        <div>
            ...
            <div>
                <h1>Uždaryti lažybas</h1>
                <div>
                    <form action="closebet.php" method="post">

                        <h3>Pasirinkite lažybas, kurias norite uždaryti</h3>
                        ...
                        <div>
                            ...
                            if (isset($_POST['bet'])) {
                                ...
                                if (!empty($_POST['bet'])) {
                                    ...
                                    echo "<div>";
                                    echo "<h3>Pasirinkite laimėjusį statymą</h3>";
                        ...
                        <div>
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if (empty($_POST['status'])) {
                                    echo "<p style=\"color:red;\">*Nepasirinkote, kuris statymas laimėjo. Bandykite iš naujo</p>";
                                    $closeCon = true;
                                }
