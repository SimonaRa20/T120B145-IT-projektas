...
function inisession($arg) {   //valom sesijos kintamuosius
			...
			$_SESSION['new_bet_title'] = "";
			$_SESSION['new_bet_title_error'] = "";
			$_SESSION['new_bet_stake_nr1']="";
			$_SESSION['new_bet_stake_nr1_error']="";
			$_SESSION['new_bet_stake_nr2']="";
			$_SESSION['new_bet_stake_nr2_error']="";
        }
