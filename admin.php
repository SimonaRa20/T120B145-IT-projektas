...
<body>
	<table style=" margin-left: auto; margin-right: auto;">
		...
		<tr>
			<td>
				<center>
					<font size="5">Vartotojų registracija, peržiūra ir įgaliojimų keitimas</font>
				</center>
			</td>
		</tr>
	</table> <br>
	...
	<form name="vartotojai" action="procadmin.php" method="post">
		<table style=" margin-left: auto; margin-right: auto; width: 50%" style=" width:75%; border-width: 2px; border-style: dotted;">
			<tr>
				<td width=30%><a href="prisijungimas.php">Atgal</a></td>
				<td width=30%>
					<?php
    if ($uregister != "self")
	    echo "<a href=\"register.php\"><b>Registruoti naują vartotoją<b></a><td>";
    else
	    echo "</td>";
    ?>

				<td width="30%">Atlikite reikalingus pakeitimus ir</td>
				<td width="10%"> <input type="submit" value="Vykdyti"></td>
			</tr>
		</table> <br>
		<?php
